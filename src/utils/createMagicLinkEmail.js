                                      ...
                                      <tbody>
                                        <tr>
                                          <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                            <h1 class="h3" style="padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 28px; line-height: 33.6px; margin: 0;" align="left">Welcome to <b>Table Topicker</b>
                                            </h1>
                                            ...
                                            <h5 class="text-red-700" style="color: #842029; padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; margin: 0;" align="left">Ready to improve your impromptu speaking skills?</h5>
                                            ...
                                            <div class="space-y-3">
                                              <p class="text-gray-700" style="line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;" align="left">
                                                Welcome to Table Topicker! Signing in allows you to keep track of your table topic history, see your timing history, and take advantage of our Generative AI Topics. Congratulations!
                                              </p>
                                              ...
                                              <p class="text-gray-700" style="line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;" align="left">Click the link below to finish creating your account and sign in to Table Topicker!</p>
                                            </div>
                                            <table class="s-5 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                              <tbody>
                                                <tr>
                                            ...
                                            <table class="btn btn-red-500" role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-radius: 6px; border-collapse: separate !important;">
                                              <tbody>
                                                <tr>
                                                  <td style="line-height: 24px; font-size: 16px; border-radius: 6px; margin: 0;" align="center" bgcolor="#dc3545">
                                                    <a href="${magicLinkUrl}" target="_blank" style="color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 20px; display: block; font-weight: normal; white-space: nowrap; background-color: #dc3545; padding: 8px 12px; border: 1px solid #dc3545;">Login to TT</a>
                                                  </td>
                                                </tr>
                                              </tbody>
                                            </table>
                                            <a href="${magicLinkUrl}" style="color: #0d6efd;">${magicLinkUrl}</a>
                                          </td>
                                        </tr>
                                      </tbody>
                                    </table>
